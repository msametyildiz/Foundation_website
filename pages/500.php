            ...
            <div class="col-lg-8 text-center">
                <div class="error-content">
                    ...
                    <div class="error-message">
                        <h2>Sunucu Hatası</h2>
                        <p class="lead">Üzgünüz, bir şeyler yanlış gitti.</p>
                        <p>Teknik ekibimiz sorun üzerinde çalışıyor. Lütfen daha sonra tekrar deneyin.</p>
                    </div>
...
<script>
// Add some animation to the 500 number
