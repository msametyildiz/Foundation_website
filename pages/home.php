            ...
            <div class="col-lg-6">
                <div class="hero-content">
                    ...
                    <div class="hero-actions">
                        <a href="<?php echo site_url('donate'); ?>" class="btn btn-hero-primary">
                            <i class="fas fa-heart"></i>
                            Bağış Yap
                        </a>
                        <a href="<?php echo site_url('volunteer'); ?>" class="btn btn-hero-secondary">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <a href="<?php echo site_url('about'); ?>" class="btn btn-outline-primary">
                        Daha Fazla Bilgi
...
<section class="projects-section py-5 bg-light">
    <div class="container">
                    ...
                    <div class="project-card">
                        <div class="project-content">
                            ...
                            <div class="project-footer">
                                <a href="<?php echo site_url('projects'); ?>" class="btn btn-primary btn-sm">
        ...
        <div class="text-center mt-4">
            <a href="<?php echo site_url('projects'); ?>" class="btn btn-primary btn-lg projects-view-all-btn">
                Tüm Projeleri Gör
                <i class="fas fa-arrow-right ms-2"></i>
            </a>
        </div>
